            ...
            <div className={type === "list"? "headerContainer listMode" : "headerContainer"}>
                ...
                </div>
                {
                    ...
                    <>
                        ...
                        <p className="headerDesc">Get awarded for your travels - unlock instant savings of 10%
                            or more with a free shivBooking account</p>

                        { !user && ( <button className="headerBtn">Sign in / Register</button> ) }

                        <div className="headerSearch">
                            <div className="headerSearchItem">
                                <FontAwesomeIcon type="text" icon={faBed} className="headerIcon" />
                                <input onChange={e=>setDestination(e.target.value)} type="text" 
                                placeholder="Where are you going ??" className="headerSearchInput" />
                            </div>
                            <div className="headerSearchItem">
                                <FontAwesomeIcon type="text" icon={faCalendarDays} className="headerIcon" />
                            ...
                            <div className="headerSearchItem">
                                <FontAwesomeIcon type="text" icon={faPerson} className="headerIcon" />
                                ...
                                {openOptions && <div className="options">
                                    ...
                                    <div className="optionItem">
                                        ...
                                        <div className="optionCounter">
                                            ...
                                            <button disabled={options.adult >= 10} className="optionCounterButton" 
